...
$(document).ready(function(){
  ...
  $("button#rollDie").click(function(){
    ...
    var gameTotal = newTurn.getTotals();
    var lastRoll = newTurn.rollsTotal.pop();

    if ((roll != 1 && (gameTotal+roll)>=25)||(roll != 1 && (gameTotal+lastRoll)>=25)) {
      ...
      $("div#newTurn").show();
      $(".displayRollsTotal").html("Current roll total = 0");
    ...
    newTurn.rollsTotal.push(rollsTotal);


    $("span.displayRollsTotal").html("Current rolls total = " + rollsTotal);

    newTurn.rollsTotal.push(0);
  ...
  $("button#newTurnButton").click(function(){
    ...
    $("div#newTurn").hide();
    $(".rollButtons").show();
    $(".displayRollsTotal").html("Current roll total = ");
    newTurn.getTotals();
